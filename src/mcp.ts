 ...
 * generated from the `parameterSpec` array of action, service or publisher
 * parameters. Pinning its shape here would mean maintaining a zod description
 * of JSON Schema. The console renders it; nothing validates against it in
 * TypeScript.
 */
